 ...
 */
async function saveMessageToFirestore(data: { name: string; phone: string | null; email: string; message: string; ipAddress: string }) {
  const messagesRef = db.collection('messages');
 ...
 * @param data The contact form data.
 */
async function sendContactEmail(data: { name: string; phone: string | null; email: string; message: string }) {
